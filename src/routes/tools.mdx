...
4. My old dialog tool (code [here](https://github.com/cyphina/DialogTool)). Made in WPF and C#. I stopped using it cause I eventually integrated [this dialog tool](https://github.com/NotYetGames/DlgSystem).
...
<video width="100%" controls>
  <source src="AssetCreationToolOverview.mp4" type="video/mp4" />
