...
<main>
  <div class="m-2 mdx-content">
    ...
    Here's the <A href="https://drive.google.com/file/d/1HXYrfel-6snhQwD4lrJhTBHgO3ZAbj4f/view?usp=sharing">download link</A> for the game.
    ...
    Still fixing a lot of bugs with it especially since I haven't tested the shipping build very much. Especially some bugs surrounding like cutscenes, save/load, quitting, AI, input remapping (need to update this since I migrated from the old input to enhnanced input), etc...
