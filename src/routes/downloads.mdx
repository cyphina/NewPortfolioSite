...
<main>
  <div class="m-2 mdx-content">
    ...
    I'll try to make a strategy guide type thing later. I'd want to work on before FTUE because I would want to spend more time design the FTUE system to emulate Star Ocean Second Story R. 
    
    In that game when you unlock a tutorial there's a nice place you can revisit to see all the tutorials you've unlocked in the past.

    Press B to open the break menu and you can access the key remapping menu which gives you the latest information on all the current keybinds.
