...
I've also worked professional in the games industry the last 4 years. The game was an third-person shooter MMO and I worked as UI Engineer typically on the UI framework, doing typical engineering engineer problems while occasionally building UI like something similar to the marvel rivals healthbar, nameplates, or activity trackers.
