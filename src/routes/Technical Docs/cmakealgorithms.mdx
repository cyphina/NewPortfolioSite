...
Since I was inspired to make this from reading the book [Modern CMake for C++](https://github.com/PacktPublishing/Modern-CMake-for-Cpp-2E/tree/main) I use [Catch2](https://github.com/catchorg/Catch2) testing library the book recommended.
...
>A repo demonstrating using C++23 demonstrating this project organization can be found [here](https://gitlab.com/z.nam.ky.ha-group/z.nam.ky.ha-algopractice).
