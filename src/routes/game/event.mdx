...
There's also a custom event flag component that runs some logic based on if the gameplay tag query provided is satisfied which lets you control something besides spawning.
