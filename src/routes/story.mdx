...
3. Chasing legacy is weakness because Sephielle values clarity and not depending on wavering external systems.
2. Chasing immortality is weakness because it means fearing death and value of fleeting time.
3. Moral purity prevents grounded actions.
